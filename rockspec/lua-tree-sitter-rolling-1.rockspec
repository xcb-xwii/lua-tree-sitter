...
build = {
	...
	modules = {
		...
		['tree_sitter.query'] = 'lua/tree_sitter/query.lua',
		['tree_sitter.query_capture'] = 'lua/tree_sitter/query_capture.lua',
		['tree_sitter.query_cursor'] = 'lua/tree_sitter/query_cursor.lua',
		['tree_sitter.query_match'] = 'lua/tree_sitter/query_match.lua',
